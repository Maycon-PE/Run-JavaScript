...
export function cars() {
    ...
    const Peogeot = { modelo: 'Peogeot', velocidade: 212, delta: 160, qualidade: 12, nitro: 5 };
    const Mustang = { modelo: 'Mustang', velocidade: 307, delta: 200, qualidade: 15, nitro: 8 };
    const Golf = { modelo: 'Golf', velocidade: 200, delta: 109, qualidade: 20, nitro: 7 };
    const Brasilia = { modelo: 'Brasília', velocidade: 199, delta: 99, qualidade: 19, nitro: 16 };
    const Uno = { modelo: 'Uno', velocidade: 199, delta: 110, qualidade: 11, nitro: 5 };
    const Ford = { modelo: 'Ford', velocidade: 202, delta: 150, qualidade: 14, nitro: 6 };
    const Camaro = { modelo: 'Camaro', velocidade: 290, delta: 190, qualidade: 18, nitro: 10 };
    const Hyundai = { modelo: 'Hyundai', velocidade: 210, delta: 160, qualidade: 16, nitro: 9 };
    const Fiat = { modelo: 'Fiat', velocidade: 199, delta: 130, qualidade: 9, nitro: 5 };
    const Honda_Civic = { modelo: 'Honda', velocidade: 220, delta: 150, qualidade: 12, nitro: 6 };
    const Nissan_360Z = { modelo: 'Nissan', velocidade: 299, delta: 190, qualidade: 20, nitro: 12 };
    const lamborghini = { modelo: 'Lamborghini', velocidade: 310, delta: 210, qualidade: 19, nitro: 15 };
    const Bugatti = { modelo: 'Bugatti', velocidade: 401, delta: 200, qualidade: 22, nitro: 9 };
    const Skyline = { modelo: 'Skyline', velocidade: 320, delta: 220, qualidade: 18, nitro: 14 };
    const BMW = { modelo: 'BMW', velocidade: 260, delta: 190, qualidade: 16, nitro: 9 };
    const F1_Red_Bull = { modelo: 'Red Bull', velocidade: 390, delta: 240, qualidade: 22, nitro: 8 };
    const Paganni = { modelo: 'Paganni', velocidade: 288, delta: 220, qualidade: 18, nitro: 7 };
    const Alfa_Romeo = { modelo: 'Alfa Romeo', velocidade: 230, delta: 200, qualidade: 17, nitro: 10 };
    const Audi = { modelo: 'Audi', velocidade: 277, delta: 170, qualidade: 16, nitro: 8 };
    const Ferrari = { modelo: 'Ferrari', velocidade: 299, delta: 213, qualidade: 17, nitro: 12 };
    const Land_Rover = { modelo: 'Land Rover', velocidade: 220, delta: 160, qualidade: 14, nitro: 9 };
    const Mercedes_Benz = { modelo: 'Mercedes', velocidade: 320, delta: 180, qualidade: 18, nitro: 12 };
    const Porshe = { modelo: 'Porshe', velocidade: 289, delta: 202, qualidade: 15, nitro: 12 };
    const Jaguar = { modelo: 'Jaguar', velocidade: 310, delta: 220, qualidade: 18, nitro: 14 };
    const Maserati = { modelo: 'Maserati', velocidade: 277, delta: 200, qualidade: 15, nitro: 9 };
    const KIA = { modelo: 'KIA', velocidade: 233, delta: 170, qualidade: 13, nitro: 7 };
    const Rolls_Royce = { modelo: 'Rolls Royce', velocidade: 236, delta: 180, qualidade: 18, nitro: 7 };
    const Bentley = { modelo: 'Bentley', velocidade: 260, delta: 180, qualidade: 17, nitro: 7 };
    const Lexus = { modelo: 'Lexus', velocidade: 320, delta: 208, qualidade: 14, nitro: 9 };
    const Aston_Martin = { modelo: 'Aston Martin', velocidade: 330, delta: 200, qualidade: 20, nitro: 10 };
    const FOX = { modelo: 'Fox', velocidade: 230, delta: 160, qualidade: 19, nitro: 7 };
    const Hass = { modelo: 'Hass', velocidade: 388, delta: 310, qualidade: 24, nitro: 9 };
    const Williams = { modelo: 'Williams', velocidade: 400, delta: 299, qualidade: 26, nitro: 9 };
    const STR = { modelo: 'STR', velocidade: 388, delta: 310, qualidade: 20, nitro: 8 };
    const Renault = { modelo: 'Renault', velocidade: 396, delta: 300, qualidade: 24, nitro: 10 };
    const Mercedes = { modelo: 'Mercedes', velocidade: 403, delta: 310, qualidade: 26, nitro: 12 };
    const Racing_Point = { modelo: 'Racing', velocidade: 390, delta: 289, qualidade: 21, nitro: 9 };
    const McLarem = { modelo: 'MacLarem', velocidade: 402, delta: 299, qualidade: 25, nitro: 11 };
    const F1_Ferrari = { modelo: 'Ferrari', velocidade: 412, delta: 310, qualidade: 26, nitro: 12 };
    const Fumaca = { modelo: 'Fumaça', velocidade: 370, delta: 360, qualidade: 17, nitro: 4 };
    const Sombra = { modelo: 'Shadow', velocidade: 450, delta: 250, qualidade: 22, nitro: 25 };
    const Fusca = { modelo: 'Fusca_51', velocidade: 220, delta: 190, qualidade: 5, nitro: 7 };
