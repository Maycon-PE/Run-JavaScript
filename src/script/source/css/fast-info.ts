export default function(put = true) {
  if (put) {
    document.querySelectorAll('.nomes-modelos').forEach((td: HTMLElement, index) =>{
    ...
    document.querySelectorAll('.nomes-modelos').forEach((td: HTMLElement) =>{
