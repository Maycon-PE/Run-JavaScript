...
export function cars(): ICar[] {
    ...
    const Peogeot: ICar = { modelo: 'Peogeot', velocidade: 212, delta: 160, qualidade: 20, nitro: 5 }
    const Mustang: ICar = { modelo: 'Mustang', velocidade: 307, delta: 200, qualidade: 40, nitro: 8 }
    const Golf: ICar = { modelo: 'Golf', velocidade: 200, delta: 109, qualidade: 20, nitro: 7 }
    const Brasilia: ICar = { modelo: 'Brasília', velocidade: 199, delta: 99, qualidade: 10, nitro: 16 }
    const Uno: ICar = { modelo: 'Uno', velocidade: 199, delta: 110, qualidade: 20, nitro: 5 }
    const Ford: ICar = { modelo: 'Ford', velocidade: 202, delta: 150, qualidade: 28, nitro: 6 }
    const Camaro: ICar = { modelo: 'Camaro', velocidade: 290, delta: 190, qualidade: 50, nitro: 10 }
    const Hyundai: ICar = { modelo: 'Hyundai', velocidade: 210, delta: 160, qualidade: 30, nitro: 9 }
    const Fiat: ICar = { modelo: 'Fiat', velocidade: 199, delta: 130, qualidade: 20, nitro: 5 }
    const Honda_Civic: ICar = { modelo: 'Honda', velocidade: 220, delta: 150, qualidade: 25, nitro: 6 }
    const Nissan_360Z: ICar = { modelo: 'Nissan', velocidade: 299, delta: 190, qualidade: 60, nitro: 12 }
    const lamborghini: ICar = { modelo: 'Lamborghini', velocidade: 310, delta: 210, qualidade: 70, nitro: 15 }
    const Bugatti: ICar = { modelo: 'Bugatti', velocidade: 401, delta: 200, qualidade: 80, nitro: 9 }
    const Skyline: ICar = { modelo: 'Skyline', velocidade: 320, delta: 220, qualidade: 77, nitro: 14 }
    const BMW: ICar = { modelo: 'BMW', velocidade: 260, delta: 190, qualidade: 66, nitro: 9 }
    const F1_Red_Bull: ICar = { modelo: 'Red Bull', velocidade: 390, delta: 240, qualidade: 88, nitro: 8 }
    const Paganni: ICar = { modelo: 'Paganni', velocidade: 288, delta: 220, qualidade: 68, nitro: 7 }
    const Alfa_Romeo: ICar = { modelo: 'Alfa Romeo', velocidade: 230, delta: 200, qualidade: 55, nitro: 10 }
    const Audi: ICar = { modelo: 'Audi', velocidade: 277, delta: 170, qualidade: 50, nitro: 8 }
    const Ferrari: ICar = { modelo: 'Ferrari', velocidade: 299, delta: 213, qualidade: 60, nitro: 12 }
    const Land_Rover: ICar = { modelo: 'Land Rover', velocidade: 220, delta: 160, qualidade: 54, nitro: 9 }
    const Mercedes_Benz: ICar = { modelo: 'Mercedes', velocidade: 320, delta: 180, qualidade: 77, nitro: 12 }
    const Porshe: ICar = { modelo: 'Porshe', velocidade: 289, delta: 202, qualidade: 69, nitro: 12 }
    const Jaguar: ICar = { modelo: 'Jaguar', velocidade: 310, delta: 220, qualidade: 80, nitro: 14 }
    const Maserati: ICar = { modelo: 'Maserati', velocidade: 277, delta: 200, qualidade: 75, nitro: 9 }
    const KIA: ICar = { modelo: 'KIA', velocidade: 233, delta: 170, qualidade: 40, nitro: 7 }
    const Rolls_Royce: ICar = { modelo: 'Rolls Royce', velocidade: 236, delta: 180, qualidade: 66, nitro: 7 }
    const Bentley: ICar = { modelo: 'Bentley', velocidade: 260, delta: 180, qualidade: 60, nitro: 7 }
    const Lexus: ICar = { modelo: 'Lexus', velocidade: 320, delta: 208, qualidade: 71, nitro: 9 }
    const Aston_Martin: ICar = { modelo: 'Aston Martin', velocidade: 330, delta: 200, qualidade: 65, nitro: 10 }
    const FOX: ICar = { modelo: 'Fox', velocidade: 230, delta: 160, qualidade: 21, nitro: 7 }
    const Hass: ICar = { modelo: 'Hass', velocidade: 388, delta: 310, qualidade: 79, nitro: 9 }
    const Williams: ICar = { modelo: 'Williams', velocidade: 400, delta: 299, qualidade: 99, nitro: 9 }
    const STR: ICar = { modelo: 'STR', velocidade: 388, delta: 310, qualidade: 88, nitro: 8 }
    const Renault: ICar = { modelo: 'Renault', velocidade: 396, delta: 300, qualidade: 71, nitro: 10 }
    const Mercedes: ICar = { modelo: 'Mercedes F1', velocidade: 403, delta: 310, qualidade: 87, nitro: 12 }
    const Racing_Point: ICar = { modelo: 'Racing', velocidade: 390, delta: 289, qualidade: 69, nitro: 9 }
    const McLarem: ICar = { modelo: 'MacLarem', velocidade: 402, delta: 299, qualidade: 88, nitro: 11 }
    const F1_Ferrari: ICar = { modelo: 'Ferrari F1', velocidade: 412, delta: 310, qualidade: 90, nitro: 12 }
    const Fumaca: ICar = { modelo: 'Fumaça', velocidade: 370, delta: 360, qualidade: 60, nitro: 4 }
    const Sombra: ICar = { modelo: 'Shadow', velocidade: 450, delta: 250, qualidade: 40, nitro: 25 }
    const Fusca: ICar = { modelo: 'Fusca_51', velocidade: 220, delta: 190, qualidade: 30, nitro: 7 }
